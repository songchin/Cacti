	...
	if (is_array($snmp_query_array)) {
		...
		foreach ($suggested_values as $suggested_value) {
			...
			if (!isset($suggested_values_graph[$graph_template_id]{$suggested_value["field_name"]})) {
				$subs_string = substitute_data_query_variables($suggested_value["text"], $host_id, $snmp_query_array["snmp_query_id"], $snmp_query_array["snmp_index"], read_config_option("max_data_query_field_length"));
