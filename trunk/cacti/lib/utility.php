		...
		if (($data_input["type_id"] == DATA_INPUT_TYPE_SCRIPT) || ($data_input["type_id"] == DATA_INPUT_TYPE_PHP_SCRIPT_SERVER)) { /* script */
			...
			$host_fields = array_rekey(db_fetch_assoc("select
				...
				where (data_input_fields.type_code='snmp_oid'
					...
					or data_input_fields.type_code='snmpv3_auth_username'
					or data_input_fields.type_code='snmpv3_auth_password'
					or data_input_fields.type_code='snmpv3_auth_protocol'
					or data_input_fields.type_code='snmpv3_priv_passphrase'
