...
function upgrade_to_0_8_7() {
	...
	db_indtall_execute("0.8.7", "INSERT INTO `data_input_fields` FIELDS (hash,data_input_id,name,data_name,input_output,update_rra,sequence,type_code,regexp_match,allow_nulls) VALUES ('0979c0fb287db7db9fa9adddbb399aa3','1','SNMP Authorization Protocol (v3)','snmpv3_auth_protocol','in','','0','snmpv3_auth_protocol','','on';");
	db_indtall_execute("0.8.7", "INSERT INTO `data_input_fields` FIELDS (hash,data_input_id,name,data_name,input_output,update_rra,sequence,type_code,regexp_match,allow_nulls) VALUES ('a5dfa3c1fe626393994a4f28d83d0c63','1','SNMP Privacy Passphrase (v3)','snmpv3_priv_passphrase','in','','0','snmpv3_priv_passphrase','','on';");
	db_indtall_execute("0.8.7", "INSERT INTO `data_input_fields` FIELDS (hash,data_input_id,name,data_name,input_output,update_rra,sequence,type_code,regexp_match,allow_nulls) VALUES ('f986f1acfd61582c3bf035ecd985b49f','1','SNMP Privacy Protocol (v3)','snmpv3_priv_protocol','in','','0','snmpv3_priv_protocol','','on';");
