...
function upgrade_to_0_8_7() {
	...
	db_install_execute("0.8.7", "ALTER TABLE `poller` CHANGE `ip_address` `description` varchar(150);");
	db_install_execute("0.8.7", "INSERT INTO poller set id = '0', hostname = 'localhost', description = 'Main Cacti System';");
}
?>