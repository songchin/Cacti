...
function item_edit() {
	...
	html_start_box("<strong>Graph Item</strong> [Graph Template: " . db_fetch_cell("select template_name from graph_template where id=" . $_GET["graph_template_id"]) . "]", "98%", $colors["header_background"], "3", "center", "");
