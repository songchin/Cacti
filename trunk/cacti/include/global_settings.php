...
$settings_graphs = array(
	...
	"tree" => array(
		...
		"default_dual_pane_width" => array(
			"friendly_name" => _("Dual Pane Tree Width"),
			"description" => _("When choosing dual pane Tree View, what width should the tree occupy in pixels."),
			"method" => "textbox",
			"max_length" => "5",
			"default" => "200"
			),
