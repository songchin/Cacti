...
<table width="100%" height="100%" cellspacing="0" cellpadding="0">
	...
	<tr class="noprint">
		<td bgcolor="#<?php print $colors['graph_menu_background'];?>" colspan="1" height="8" style="background-image: url(<?php print html_get_theme_images_path('shadow_gray.gif');?>); background-repeat: repeat-x; border-right: #<?php print $colors['graph_menu_border'];?> 1px solid;">
			<img src="<?php print html_get_theme_images_path('transparent_line.gif');?>" width="<?php print read_graph_config_option("default_dual_pane_width");?>" height="2" border="0"><br>
		</td>
	...
	<tr>
		...
		<td valign="top" style="padding: 5px; border-right: #<?php print $colors['graph_menu_border'];?> 1px solid;" bgcolor="#<?php print $colors['graph_menu_background'];?>" width="<?php print read_graph_config_option("default_dual_pane_width");?>" class="noprint">
