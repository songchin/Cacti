...
$fields_data_input_edit = array(
	"name" => array(
		"method" => "textbox",
		"friendly_name" => "Name",
		"description" => "Enter a meaningful name for this script.",
		"value" => "|arg1:name|",
		"max_length" => "255",
		),
	"type_id" => array(
		...
		"description" => "Choose what type of script this is.",
		"value" => "|arg1:type_id|",
		"array" => $script_types,
		),
	"input_string" => array(
		...
		"description" => "The data that is sent to the script, which includes the complete path to the script and input fields in &lt;&gt; brackets.",
...
$fields_data_input_field_edit_input = array(
	"field_input_type" => array(
		"friendly_name" => "Input Field Type",
		"redirect_url" => "",
		"form_index" => "",
		...
		"description" => "Select where this data input field will obtain its value."
		)
	);
...
$fields_data_input_field_edit_input_custom = array(
	...
	"field_input_value" => array(
		...
		"description" => "Enter a default value for this input field.",
...
$fields_data_input_field_edit_input_device = array(
	"hdr_custom" => array(
		"friendly_name" => "Device Field Value",
		"method" => "spacer"
		),
	"field_input_value" => array(
		"friendly_name" => "Device Field",
		"redirect_url" => "",
		"form_index" => "",
		"method" => "drop_array_js",
		"array" => array(
		...
		"default" => "hostname",
		//"value" => "|arg1:field_input_value|",
		"description" => "Select the device field that will be used to populate this input field."
		)
	);
...
$fields_data_input_field_edit = array(
	"data_name" => array(
		"method" => "textbox",
		"friendly_name" => "Field [|arg2:|]",
		"description" => "Enter a name for this |arg2:| field.",
	...
	"name" => array(
		...
		"description" => "Enter a meaningful name for this data input field.",
		"value" => "|arg1:name|",
		"max_length" => "200",
		),
	"update_rrd" => array(
		...
		"description" => "Whether data from this output field is to be entered into the RRD file. Fields values that are not entered into the RRD can still be used as variables on graphs.",
	...
	"allow_empty" => array(
		...
		"description" => "Check here if you want to allow empty input in this field.",
