...
$data_query_input_types = array(
	DATA_QUERY_INPUT_TYPE_SNMP_QUERY => _("SNMP"),
	DATA_QUERY_INPUT_TYPE_SCRIPT_QUERY => _("Script"),
	DATA_QUERY_INPUT_TYPE_PHP_SCRIPT_SERVER_QUERY => _("Script (Using PHP Script Server)")
	);
