...
function update_reindex_cache($host_id, $data_query_id) {
	...
	$data_query_type = db_fetch_cell("select data_input.type_id from (data_input cross join snmp_query) where data_input.id=snmp_query.data_input_id and snmp_query.id=$data_query_id");
