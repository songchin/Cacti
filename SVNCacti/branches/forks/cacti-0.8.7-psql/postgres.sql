...
DROP TABLE "cdef" CASCADE\g
DROP SEQUENCE "cdef_id_seq" CASCADE ;

CREATE SEQUENCE "cdef_id_seq" START 16;

CREATE TABLE  "cdef" (
   "id" integer DEFAULT nextval('"cdef_id_seq"') NOT NULL,
...
DROP TABLE "cdef_items" CASCADE\g
DROP SEQUENCE "cdef_items_id_seq" CASCADE ;

CREATE SEQUENCE "cdef_items_id_seq" START 24;

CREATE TABLE  "cdef_items" (
   "id" integer DEFAULT nextval('"cdef_items_id_seq"') NOT NULL,
   "hash"   varchar(32) NOT NULL default '', 
   "cdef_id"  integer CHECK ("cdef_id" >= 0) NOT NULL default '0',
   "sequence"  integer CHECK ("sequence" >= 0) NOT NULL default '0',
   "type"    smallint NOT NULL default '0', 
   "value"   varchar(150) NOT NULL default '', 
   primary key ("id")
)  ;
CREATE INDEX "cdef_items_cdef_id_idx" ON "cdef_items" USING btree ("cdef_id");
...
DROP TABLE "colors" CASCADE\g
DROP SEQUENCE "colors_id_seq" CASCADE ;

CREATE SEQUENCE "colors_id_seq" START 105;
...
DROP TABLE "data_input" CASCADE\g
DROP SEQUENCE "data_input_id_seq" CASCADE ;

CREATE SEQUENCE "data_input_id_seq" START 13;

CREATE TABLE  "data_input" (
   "id" integer DEFAULT nextval('"data_input_id_seq"') NOT NULL,
   "hash"   varchar(32) NOT NULL default '', 
...
CREATE INDEX "data_input_name_idx" ON "data_input" USING btree ("name");
...
DROP TABLE "data_input_data" CASCADE\g
CREATE TABLE  "data_input_data" (
   "data_input_field_id"  integer CHECK ("data_input_field_id" >= 0) NOT NULL default '0',
   "data_template_data_id"  integer CHECK ("data_template_data_id" >= 0) NOT NULL default '0',
...
DROP TABLE "data_input_fields" CASCADE\g
DROP SEQUENCE "data_input_fields_id_seq" CASCADE ;

CREATE SEQUENCE "data_input_fields_id_seq" START 41;

CREATE TABLE  "data_input_fields" (
   "id" integer DEFAULT nextval('"data_input_fields_id_seq"') NOT NULL,
   "hash"   varchar(32) NOT NULL default '', 
   "data_input_id"  integer CHECK ("data_input_id" >= 0) NOT NULL default '0',
   "name"   varchar(200) NOT NULL default '', 
...
CREATE INDEX "data_input_fields_data_input_id_idx" ON "data_input_fields" USING btree ("data_input_id");
...
DROP TABLE "data_local" CASCADE\g
DROP SEQUENCE "data_local_id_seq" CASCADE ;

CREATE SEQUENCE "data_local_id_seq" START 8;

CREATE TABLE  "data_local" (
   "id" integer DEFAULT nextval('"data_local_id_seq"') NOT NULL,
   "data_template_id"  integer CHECK ("data_template_id" >= 0) NOT NULL default '0',
   "host_id"  integer CHECK ("host_id" >= 0) NOT NULL default '0',
   "snmp_query_id"    integer NOT NULL default '0', 
...
DROP TABLE "data_template" CASCADE\g
DROP SEQUENCE "data_template_id_seq" CASCADE ;

CREATE SEQUENCE "data_template_id_seq" START 49;

CREATE TABLE  "data_template" (
   "id" integer DEFAULT nextval('"data_template_id_seq"') NOT NULL,
   "hash"   varchar(32) NOT NULL default '', 
...
DROP TABLE "data_template_data" CASCADE\g
DROP SEQUENCE "data_template_data_id_seq" CASCADE ;

CREATE SEQUENCE "data_template_data_id_seq" START 70;

CREATE TABLE  "data_template_data" (
   "id" integer DEFAULT nextval('"data_template_data_id_seq"') NOT NULL,
   "local_data_template_data_id"  integer CHECK ("local_data_template_data_id" >= 0) NOT NULL default '0',
   "local_data_id"  integer CHECK ("local_data_id" >= 0) NOT NULL default '0',
   "data_template_id"  integer CHECK ("data_template_id" >= 0) NOT NULL default '0',
   "data_input_id"  integer CHECK ("data_input_id" >= 0) NOT NULL default '0',
   ...
   "rrd_step"  integer CHECK ("rrd_step" >= 0) NOT NULL default '0',
   "t_rra_id"   varchar(2) default NULL, 
   primary key ("id")
)  ;
CREATE INDEX "data_template_data_local_data_id_idx" ON "data_template_data" USING btree ("local_data_id");
CREATE INDEX "data_template_data_data_template_id_idx" ON "data_template_data" USING btree ("data_template_id");
...
DROP TABLE "data_template_data_rra" CASCADE\g
CREATE TABLE  "data_template_data_rra" (
   "data_template_data_id"  integer CHECK ("data_template_data_id" >= 0) NOT NULL default '0',
   "rra_id"  integer CHECK ("rra_id" >= 0) NOT NULL default '0',
   primary key ("data_template_data_id", "rra_id")
)  ;
CREATE INDEX "data_template_data_rra_data_template_data_id_idx" ON "data_template_data_rra" USING btree ("data_template_data_id");
...
DROP TABLE "data_template_rrd" CASCADE\g
DROP SEQUENCE "data_template_rrd_id_seq" CASCADE ;

CREATE SEQUENCE "data_template_rrd_id_seq" START 97;

CREATE TABLE  "data_template_rrd" (
   "id" integer DEFAULT nextval('"data_template_rrd_id_seq"') NOT NULL,
   "hash"   varchar(32) NOT NULL default '', 
   "local_data_template_rrd_id"  integer CHECK ("local_data_template_rrd_id" >= 0) NOT NULL default '0',
   "local_data_id"  integer CHECK ("local_data_id" >= 0) NOT NULL default '0',
   "data_template_id"  integer CHECK ("data_template_id" >= 0) NOT NULL default '0',
   ...
   "rrd_heartbeat"    integer NOT NULL default '0', 
...
CREATE INDEX "data_template_rrd_local_data_id_idx" ON "data_template_rrd" USING btree ("local_data_id");
CREATE INDEX "data_template_rrd_data_template_id_idx" ON "data_template_rrd" USING btree ("data_template_id");
...
DROP TABLE "graph_local" CASCADE\g
DROP SEQUENCE "graph_local_id_seq" CASCADE ;

CREATE SEQUENCE "graph_local_id_seq" START 5;

CREATE TABLE  "graph_local" (
   "id" integer DEFAULT nextval('"graph_local_id_seq"') NOT NULL,
   "graph_template_id"  integer CHECK ("graph_template_id" >= 0) NOT NULL default '0',
   "host_id"  integer CHECK ("host_id" >= 0) NOT NULL default '0',
   "snmp_query_id"    integer NOT NULL default '0', 
   "snmp_index"   varchar(255) NOT NULL default '', 
   primary key ("id")
)   ;
CREATE INDEX "graph_local_host_id_idx" ON "graph_local" USING btree ("host_id");
CREATE INDEX "graph_local_graph_template_id_idx" ON "graph_local" USING btree ("graph_template_id");
CREATE INDEX "graph_local_snmp_index_idx" ON "graph_local" USING btree ("snmp_index");
COMMENT ON TABLE "graph_local" IS 'Creates a relationship for each item in a custom graph.';
...
DROP TABLE "graph_template_input" CASCADE\g
DROP SEQUENCE "graph_template_input_id_seq" CASCADE ;

CREATE SEQUENCE "graph_template_input_id_seq" START 84;

CREATE TABLE  "graph_template_input" (
   "id" integer DEFAULT nextval('"graph_template_input_id_seq"') NOT NULL,
   "hash"   varchar(32) NOT NULL default '', 
   "graph_template_id"  integer CHECK ("graph_template_id" >= 0) NOT NULL default '0',
   "name"   varchar(255) NOT NULL default '', 
   "description"   text, 
...
COMMENT ON TABLE "graph_template_input" IS 'Stores the names for graph item input groups.';
...
DROP TABLE "graph_template_input_defs" CASCADE\g
CREATE TABLE  "graph_template_input_defs" (
   "graph_template_input_id"  integer CHECK ("graph_template_input_id" >= 0) NOT NULL default '0',
   "graph_template_item_id" int CHECK ("graph_template_item_id" >= 0) NOT NULL default '0',
   primary key ("graph_template_input_id", "graph_template_item_id")
)   ;
CREATE INDEX "graph_template_input_defs_graph_template_input_id_idx" ON "graph_template_input_defs" USING btree ("graph_template_input_id");
COMMENT ON TABLE "graph_template_input_defs" IS 'Stores the relationship for what graph iitems are associated';
...
DROP TABLE "graph_templates" CASCADE\g
DROP SEQUENCE "graph_templates_id_seq" CASCADE ;

CREATE SEQUENCE "graph_templates_id_seq" START 35;

CREATE TABLE  "graph_templates" (
   "id" integer DEFAULT nextval('"graph_templates_id_seq"') NOT NULL,
   "hash"   varchar(32) NOT NULL default '', 
   "name"   varchar(255) NOT NULL default '', 
   primary key ("id")
)   ;
CREATE INDEX "graph_templates_name_idx" ON "graph_templates" USING btree ("name");
COMMENT ON TABLE "graph_templates" IS 'Contains each graph template name.';
...
DROP TABLE "graph_templates_gprint" CASCADE\g
DROP SEQUENCE "graph_templates_gprint_id_seq" CASCADE ;

CREATE SEQUENCE "graph_templates_gprint_id_seq" START 5;

CREATE TABLE  "graph_templates_gprint" (
   "id" integer DEFAULT nextval('"graph_templates_gprint_id_seq"') NOT NULL,
   "hash"   varchar(32) NOT NULL default '', 
...
DROP TABLE "graph_templates_graph" CASCADE\g
DROP SEQUENCE "graph_templates_graph_id_seq" CASCADE ;

CREATE SEQUENCE "graph_templates_graph_id_seq" START 48;

CREATE TABLE  "graph_templates_graph" (
   "id" integer DEFAULT nextval('"graph_templates_graph_id_seq"') NOT NULL,
   "local_graph_template_graph_id"  integer CHECK ("local_graph_template_graph_id" >= 0) NOT NULL default '0',
   "local_graph_id"  integer CHECK ("local_graph_id" >= 0) NOT NULL default '0',
   "graph_template_id"  integer CHECK ("graph_template_id" >= 0) NOT NULL default '0',
   "t_image_format_id"   varchar(2) default '0', 
   "image_format_id"    smallint NOT NULL default '0', 
   ...
   "auto_scale_opts"    smallint NOT NULL default '0', 
...
CREATE INDEX "graph_templates_graph_local_graph_id_idx" ON "graph_templates_graph" USING btree ("local_graph_id");
CREATE INDEX "graph_templates_graph_graph_template_id_idx" ON "graph_templates_graph" USING btree ("graph_template_id");
CREATE INDEX "graph_templates_graph_title_cache_idx" ON "graph_templates_graph" USING btree ("title_cache");
COMMENT ON TABLE "graph_templates_graph" IS 'Stores the actual graph data.';
...
DROP TABLE "graph_templates_item" CASCADE\g
DROP SEQUENCE "graph_templates_item_id_seq" CASCADE ;

CREATE SEQUENCE "graph_templates_item_id_seq" START 411;

CREATE TABLE  "graph_templates_item" (
   "id" integer DEFAULT nextval('"graph_templates_item_id_seq"') NOT NULL,
   "hash"   varchar(32) NOT NULL default '', 
   "local_graph_template_item_id" int CHECK ("local_graph_template_item_id" >= 0) NOT NULL default '0',
   "local_graph_id"  integer CHECK ("local_graph_id" >= 0) NOT NULL default '0',
   "graph_template_id"  integer CHECK ("graph_template_id" >= 0) NOT NULL default '0',
   "task_item_id"  integer CHECK ("task_item_id" >= 0) NOT NULL default '0',
   "color_id"  integer CHECK ("color_id" >= 0) NOT NULL default '0',
   "graph_type_id"    smallint NOT NULL default '0', 
   "cdef_id"  integer CHECK ("cdef_id" >= 0) NOT NULL default '0',
   "consolidation_function_id"    smallint NOT NULL default '0', 
   "text_format"   varchar(255) default NULL, 
   "value"   varchar(255) default NULL, 
   "hard_return"   varchar(2) default NULL, 
   "gprint_id"  integer CHECK ("gprint_id" >= 0) NOT NULL default '0',
   "sequence"  integer CHECK ("sequence" >= 0) NOT NULL default '0',
   primary key ("id")
)   ;
CREATE INDEX "graph_templates_item_graph_template_id_idx" ON "graph_templates_item" USING btree ("graph_template_id");
CREATE INDEX "graph_templates_item_local_graph_id_idx" ON "graph_templates_item" USING btree ("local_graph_id");
COMMENT ON TABLE "graph_templates_item" IS 'Stores the actual graph item data.';
...
DROP TABLE "graph_tree" CASCADE\g
DROP SEQUENCE "graph_tree_id_seq" CASCADE ;

CREATE SEQUENCE "graph_tree_id_seq" START 2;

CREATE TABLE  "graph_tree" (
   "id" integer DEFAULT nextval('"graph_tree_id_seq"') NOT NULL,
   "sort_type"  smallint CHECK ("sort_type" >= 0) NOT NULL default '1',
   "name"   varchar(255) NOT NULL default '', 
   primary key ("id")
)  ;
...
DROP TABLE "graph_tree_items" CASCADE\g
DROP SEQUENCE "graph_tree_items_id_seq" CASCADE ;

CREATE SEQUENCE "graph_tree_items_id_seq" START 8;

CREATE TABLE  "graph_tree_items" (
   "id" integer DEFAULT nextval('"graph_tree_items_id_seq"') NOT NULL,
   "graph_tree_id" smallint CHECK ("graph_tree_id" >= 0) NOT NULL default '0',
   "local_graph_id"  integer CHECK ("local_graph_id" >= 0) NOT NULL default '0',
   "rra_id" smallint CHECK ("rra_id" >= 0) NOT NULL default '0',
   "title"   varchar(255) default NULL, 
   "host_id"  integer CHECK ("host_id" >= 0) NOT NULL default '0',
   "order_key"   varchar(100) NOT NULL default '0', 
   "host_grouping_type"  smallint CHECK ("host_grouping_type" >= 0) NOT NULL default '1',
   "sort_children_type"  smallint CHECK ("sort_children_type" >= 0) NOT NULL default '1',
   primary key ("id")
)  ;
CREATE INDEX "graph_tree_items_graph_tree_id_idx" ON "graph_tree_items" USING btree ("graph_tree_id");
CREATE INDEX "graph_tree_items_host_id_idx" ON "graph_tree_items" USING btree ("host_id");
CREATE INDEX "graph_tree_items_local_graph_id_idx" ON "graph_tree_items" USING btree ("local_graph_id");
CREATE INDEX "graph_tree_items_order_key_idx" ON "graph_tree_items" USING btree ("order_key");
...
CREATE SEQUENCE "host_id_seq" START 2;

CREATE TABLE  "host" (
   "id" integer DEFAULT nextval('"host_id_seq"') NOT NULL,
   "host_template_id"  integer CHECK ("host_template_id" >= 0) NOT NULL default '0',
   "description"   varchar(150) NOT NULL default '', 
   "hostname"   varchar(250) default NULL, 
   "notes"   text,
   "snmp_community"   varchar(100) default NULL, 
   "snmp_version"  smallint CHECK ("snmp_version" >= 0) NOT NULL default '1',
   ...
   "snmp_port"  integer CHECK ("snmp_port" >= 0) NOT NULL default '161',
   "snmp_timeout"  integer CHECK ("snmp_timeout" >= 0) NOT NULL default '500',
   "availability_method" smallint CHECK ("availability_method" >= 0) NOT NULL default '2',
   "ping_method" smallint CHECK ("ping_method" >= 0) NOT NULL default '0',
   "ping_port" int CHECK ("ping_port" >= 0) NOT NULL default '0',
   "ping_timeout" int CHECK ("ping_timeout" >= 0) NOT NULL default '500',
   "ping_retries" int CHECK ("ping_retries" >= 0) NOT NULL default '2',
   "max_oids" int CHECK ("max_oids" >= 0) NOT NULL default '10',
   "disabled"   varchar(2) default NULL, 
   "status"    smallint NOT NULL default '0', 
   "status_event_count"  integer CHECK ("status_event_count" >= 0) NOT NULL default '0',
   "status_fail_date"   timestamp without time zone NOT NULL default '1970-01-01 00:00:00', 
   "status_rec_date"   timestamp without time zone NOT NULL default '1970-01-01 00:00:00', 
   ...
   "total_polls" int CHECK ("total_polls" >= 0) default '0',
   "failed_polls" int CHECK ("failed_polls" >= 0) default '0',
   "availability"   decimal(8,5) NOT NULL default '100.00000', 
   primary key ("id")
)  ;
CREATE INDEX "host_disabled_idx" ON "host" USING btree ("disabled");

INSERT INTO host VALUES (1, 8, 'Localhost', '127.0.0.1', '', 'public', 0, '', '', 'MD5', '', 'DES', '', 161, 500, 3, 2, 23, 400, 1, 10, '', 0, 0, '1970-01-01 00:00:00', '1970-01-01 00:00:00', '', 9.99999, 0.00000, 0.00000, 0.00000, 0, 0, 100.00000);

--
-- Table structure for table host_graph
--

DROP TABLE "host_graph" CASCADE\g
...
DROP TABLE "host_snmp_cache" CASCADE\g
CREATE TABLE  "host_snmp_cache" (
   "host_id"  integer CHECK ("host_id" >= 0) NOT NULL default '0',
   "snmp_query_id"  integer CHECK ("snmp_query_id" >= 0) NOT NULL default '0',
...
CREATE INDEX "host_snmp_cache_1_idx" ON "host_snmp_cache" USING btree ("host_id", "field_name");
CREATE INDEX "host_snmp_cache_snmp_index_idx" ON "host_snmp_cache" USING btree ("snmp_index");

--
-- Table structure for table host_snmp_query
--

DROP TABLE "host_snmp_query" CASCADE\g
CREATE TABLE  "host_snmp_query" (
   "host_id"  integer CHECK ("host_id" >= 0) NOT NULL default '0',
   "snmp_query_id"  integer CHECK ("snmp_query_id" >= 0) NOT NULL default '0',
   "sort_field"   varchar(50) NOT NULL default '', 
   "title_format"   varchar(50) NOT NULL default '', 
   "reindex_method"  smallint CHECK ("reindex_method" >= 0) NOT NULL default '0',
   primary key ("host_id", "snmp_query_id")
)  ;
CREATE INDEX "host_snmp_query_host_id_idx" ON "host_snmp_query" USING btree ("host_id");
...
DROP TABLE "host_template" CASCADE\g
DROP SEQUENCE "host_template_id_seq" CASCADE ;

CREATE SEQUENCE "host_template_id_seq" START 9;

CREATE TABLE  "host_template" (
   "id" integer DEFAULT nextval('"host_template_id_seq"') NOT NULL,
   "hash"   varchar(32) NOT NULL default '', 
   "name"   varchar(100) NOT NULL default '', 
   primary key ("id")
)  ;
...
DROP TABLE "host_template_graph" CASCADE\g
CREATE TABLE  "host_template_graph" (
   "host_template_id"  integer CHECK ("host_template_id" >= 0) NOT NULL default '0',
   "graph_template_id"  integer CHECK ("graph_template_id" >= 0) NOT NULL default '0',
   primary key ("host_template_id", "graph_template_id")
)  ;
CREATE INDEX "host_template_graph_host_template_id_idx" ON "host_template_graph" USING btree ("host_template_id");
...
DROP TABLE "host_template_snmp_query" CASCADE\g
CREATE TABLE  "host_template_snmp_query" (
   "host_template_id"  integer CHECK ("host_template_id" >= 0) NOT NULL default '0',
   "snmp_query_id"  integer CHECK ("snmp_query_id" >= 0) NOT NULL default '0',
   primary key ("host_template_id", "snmp_query_id")
)  ;
CREATE INDEX "host_template_snmp_query_host_template_id_idx" ON "host_template_snmp_query" USING btree ("host_template_id");
...
DROP TABLE "poller" CASCADE\g
DROP SEQUENCE "poller_id_seq" CASCADE ;

CREATE SEQUENCE "poller_id_seq" ;

CREATE TABLE  "poller" (
   "id" integer DEFAULT nextval('"poller_id_seq"') NOT NULL,
   "hostname"   varchar(250) NOT NULL default '', 
   "ip_address" int CHECK ("ip_address" >= 0) NOT NULL default '0',
...
DROP TABLE "poller_command" CASCADE\g
CREATE TABLE  "poller_command" (
   "poller_id" smallint CHECK ("poller_id" >= 0) NOT NULL default '0',
   "time"   timestamp without time zone NOT NULL default '1970-01-01 00:00:00', 
   "action"  smallint CHECK ("action" >= 0) NOT NULL default '0',
...
DROP TABLE "poller_item" CASCADE\g
CREATE TABLE  "poller_item" (
   "local_data_id"  integer CHECK ("local_data_id" >= 0) NOT NULL default '0',
   "poller_id" smallint CHECK ("poller_id" >= 0) NOT NULL default '0',
   "host_id"    integer NOT NULL default '0', 
   "action"  smallint CHECK ("action" >= 0) NOT NULL default '1',
   "hostname"   varchar(250) NOT NULL default '', 
   "snmp_community"   varchar(100) NOT NULL default '', 
   "snmp_version"  smallint CHECK ("snmp_version" >= 0) NOT NULL default '0',
   ...
   "snmp_context" varchar(64) default '',
   "snmp_port"  integer CHECK ("snmp_port" >= 0) NOT NULL default '161',
   "snmp_timeout"  integer CHECK ("snmp_timeout" >= 0) NOT NULL default '0',
   "rrd_name"   varchar(19) NOT NULL default '', 
   "rrd_path"   varchar(255) NOT NULL default '', 
   "rrd_num"  smallint CHECK ("rrd_num" >= 0) NOT NULL default '0',
   "rrd_step"  integer CHECK ("rrd_step" >= 0) NOT NULL default '300',
   "rrd_next_step"    integer NOT NULL default '0', 
   "arg1"   text, 
   "arg2"   varchar(255) default NULL, 
   "arg3"   varchar(255) default NULL, 
   primary key ("local_data_id", "rrd_name")
)  ;
CREATE INDEX "poller_item_local_data_id_idx" ON "poller_item" USING btree ("local_data_id");
CREATE INDEX "poller_item_host_id_idx" ON "poller_item" USING btree ("host_id");
CREATE INDEX "poller_item_rrd_next_step_idx" ON "poller_item" USING btree ("rrd_next_step");
CREATE INDEX "poller_item_action_idx" ON "poller_item" USING btree ("action");

--
-- Table structure for table poller_output
--

DROP TABLE "poller_output" CASCADE\g
...
DROP TABLE "poller_reindex" CASCADE\g
CREATE TABLE  "poller_reindex" (
   "host_id"  integer CHECK ("host_id" >= 0) NOT NULL default '0',
   "data_query_id"  integer CHECK ("data_query_id" >= 0) NOT NULL default '0',
   "action"  smallint CHECK ("action" >= 0) NOT NULL default '0',
   "op"   varchar(1) NOT NULL default '', 
...
DROP TABLE "poller_time" CASCADE\g
DROP SEQUENCE "poller_time_id_seq" CASCADE ;

CREATE SEQUENCE "poller_time_id_seq" ;

CREATE TABLE  "poller_time" (
   "id" integer DEFAULT nextval('"poller_time_id_seq"') NOT NULL,
   "pid" int CHECK ("pid" >= 0) NOT NULL default '0',
   "poller_id" smallint CHECK ("poller_id" >= 0) NOT NULL default '0',
   "start_time"   timestamp without time zone NOT NULL default '1970-01-01 00:00:00', 
   "end_time"   timestamp without time zone NOT NULL default '1970-01-01 00:00:00', 
   primary key ("id")
)  ;
...
DROP TABLE "rra" CASCADE\g
DROP SEQUENCE "rra_id_seq" CASCADE ;

CREATE SEQUENCE "rra_id_seq" START 5;

CREATE TABLE  "rra" (
   "id" integer DEFAULT nextval('"rra_id_seq"') NOT NULL,
   "hash"   varchar(32) NOT NULL default '', 
   "name"   varchar(100) NOT NULL default '', 
   "x_files_factor" double precision NOT NULL default '0.1', 
   "steps"    integer default '1', 
   "rows"   int NOT NULL default '600', 
   "timespan" int CHECK ("timespan" >= 0) NOT NULL default '0',
   primary key ("id")
)  ;
...
DROP TABLE "rra_cf" CASCADE\g
CREATE TABLE  "rra_cf" (
   "rra_id"  integer CHECK ("rra_id" >= 0) NOT NULL default '0',
   "consolidation_function_id" smallint CHECK ("consolidation_function_id" >= 0) NOT NULL default '0',
   primary key ("rra_id", "consolidation_function_id")
)  ;
CREATE INDEX "rra_cf_rra_id_idx" ON "rra_cf" USING btree ("rra_id");
...
DROP TABLE "settings_graphs" CASCADE\g
CREATE TABLE  "settings_graphs" (
   "user_id" smallint CHECK ("user_id" >= 0) NOT NULL default '0',
   "name"   varchar(50) NOT NULL default '', 
   "value"   varchar(255) NOT NULL default '', 
...
DROP TABLE "settings_tree" CASCADE\g
CREATE TABLE  "settings_tree" (
   "user_id"  integer CHECK ("user_id" >= 0) NOT NULL default '0',
   "graph_tree_item_id"  integer CHECK ("graph_tree_item_id" >= 0) NOT NULL default '0',
   "status"    smallint NOT NULL default '0', 
...
DROP TABLE "snmp_query" CASCADE\g
DROP SEQUENCE "snmp_query_id_seq" CASCADE ;

CREATE SEQUENCE "snmp_query_id_seq" START 10;

CREATE TABLE  "snmp_query" (
   "id" integer DEFAULT nextval('"snmp_query_id_seq"') NOT NULL,
   "hash"   varchar(32) NOT NULL default '', 
...
CREATE INDEX "snmp_query_name_idx" ON "snmp_query" USING btree ("name");
...
DROP TABLE "snmp_query_graph" CASCADE\g
DROP SEQUENCE "snmp_query_graph_id_seq" CASCADE ;

CREATE SEQUENCE "snmp_query_graph_id_seq" START 23;

CREATE TABLE  "snmp_query_graph" (
   "id" integer DEFAULT nextval('"snmp_query_graph_id_seq"') NOT NULL,
   "hash"   varchar(32) NOT NULL default '', 
   "snmp_query_id"  integer CHECK ("snmp_query_id" >= 0) NOT NULL default '0',
   "name"   varchar(100) NOT NULL default '', 
   "graph_template_id"  integer CHECK ("graph_template_id" >= 0) NOT NULL default '0',
...
DROP TABLE "snmp_query_graph_rrd" CASCADE\g
CREATE TABLE  "snmp_query_graph_rrd" (
   "snmp_query_graph_id"  integer CHECK ("snmp_query_graph_id" >= 0) NOT NULL default '0',
   "data_template_id"  integer CHECK ("data_template_id" >= 0) NOT NULL default '0',
   "data_template_rrd_id"  integer CHECK ("data_template_rrd_id" >= 0) NOT NULL default '0',
   "snmp_field_name"   varchar(50) NOT NULL default '0', 
   primary key ("snmp_query_graph_id", "data_template_id", "data_template_rrd_id")
)  ;
CREATE INDEX "snmp_query_graph_rrd_snmp_query_graph_id_idx" ON "snmp_query_graph_rrd" USING btree ("snmp_query_graph_id");
...
DROP TABLE "snmp_query_graph_rrd_sv" CASCADE\g
DROP SEQUENCE "snmp_query_graph_rrd_sv_id_seq" CASCADE ;

CREATE SEQUENCE "snmp_query_graph_rrd_sv_id_seq" START 110;

CREATE TABLE  "snmp_query_graph_rrd_sv" (
   "id" integer DEFAULT nextval('"snmp_query_graph_rrd_sv_id_seq"') NOT NULL,
   "hash"   varchar(32) NOT NULL default '', 
   "snmp_query_graph_id"  integer CHECK ("snmp_query_graph_id" >= 0) NOT NULL default '0',
   "data_template_id"  integer CHECK ("data_template_id" >= 0) NOT NULL default '0',
   "sequence"  integer CHECK ("sequence" >= 0) NOT NULL default '0',
...
CREATE INDEX "snmp_query_graph_rrd_sv_snmp_query_graph_id_idx" ON "snmp_query_graph_rrd_sv" USING btree ("snmp_query_graph_id");
...
DROP TABLE "snmp_query_graph_sv" CASCADE\g
DROP SEQUENCE "snmp_query_graph_sv_id_seq" CASCADE ;

CREATE SEQUENCE "snmp_query_graph_sv_id_seq" START 50;

CREATE TABLE  "snmp_query_graph_sv" (
   "id" integer DEFAULT nextval('"snmp_query_graph_sv_id_seq"') NOT NULL,
   "hash"   varchar(32) NOT NULL default '', 
   "snmp_query_graph_id"  integer CHECK ("snmp_query_graph_id" >= 0) NOT NULL default '0',
   "sequence"  integer CHECK ("sequence" >= 0) NOT NULL default '0',
   "field_name"   varchar(100) NOT NULL default '', 
...
CREATE INDEX "snmp_query_graph_sv_snmp_query_graph_id_idx" ON "snmp_query_graph_sv" USING btree ("snmp_query_graph_id");
...
DROP TABLE "user_auth" CASCADE\g
DROP SEQUENCE "user_auth_id_seq" CASCADE ;

CREATE SEQUENCE "user_auth_id_seq" START 4;
...
CREATE TABLE  "user_auth" (
   ...
   "login_opts"    smallint NOT NULL default '1', 
   "policy_graphs"  smallint CHECK ("policy_graphs" >= 0) NOT NULL default '1',
   "policy_trees"  smallint CHECK ("policy_trees" >= 0) NOT NULL default '1',
   "policy_hosts"  smallint CHECK ("policy_hosts" >= 0) NOT NULL default '1',
   "policy_graph_templates"  smallint CHECK ("policy_graph_templates" >= 0) NOT NULL default '1',
   "enabled" varchar(2) default 'on',
   primary key ("id")
)  ;
CREATE INDEX "user_auth_username_idx" ON "user_auth" USING btree ("username");
CREATE INDEX "user_auth_realm_idx" ON "user_auth" USING btree ("realm");
CREATE INDEX "user_auth_enabled_idx" ON "user_auth" USING btree ("enabled");
...
DROP TABLE "user_auth_perms" CASCADE\g
CREATE TABLE  "user_auth_perms" (
   "user_id"  integer CHECK ("user_id" >= 0) NOT NULL default '0',
   "item_id"  integer CHECK ("item_id" >= 0) NOT NULL default '0',
   "type"  smallint CHECK ("type" >= 0) NOT NULL default '0',
   primary key ("user_id", "item_id", "type")
)  ;
CREATE INDEX "user_auth_perms_1_idx" ON "user_auth_perms" USING btree ("user_id", "type");

--
-- Table structure for table user_auth_realm
--

DROP TABLE "user_auth_realm" CASCADE\g
CREATE TABLE  "user_auth_realm" (
   "realm_id"  integer CHECK ("realm_id" >= 0) NOT NULL default '0',
   "user_id"  integer CHECK ("user_id" >= 0) NOT NULL default '0',
   primary key ("realm_id", "user_id")
)  ;
CREATE INDEX "user_auth_realm_user_id_idx" ON "user_auth_realm" USING btree ("user_id");
...
CREATE INDEX "user_log_username_idx" ON "user_auth" USING btree ("username");

--
-- Table structure for table version
--

DROP TABLE "version" CASCADE\g
CREATE TABLE  "version" (
   "cacti"   varchar(20) default NULL 
)  ;
