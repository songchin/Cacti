...
function form_save() {
	if (isset($_POST["save_component_template"])) {
		...
		$save2["colortag_shadea"] = form_input_validate($_POST["colortag_shadea"], "colortag_shadea", "", true, 3);
