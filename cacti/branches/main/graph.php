				...
				<table width='1' cellpadding='0'>
					<tr>
						...
						<td valign='top' style='padding: 3px;' class='noprint'>
							<a href='graph.php?action=zoom&local_graph_id=<?php print $_GET["local_graph_id"];?>&rra_id=<?php print $rra["id"];?>&view_type=<?php print $_REQUEST["view_type"];?>'><img src='images/graph_zoom.gif' alt='Zoom Graph' title='Zoom Graph' style='border-width:0px;padding:3px;'></a><br>
							<a href='graph_xport.php?local_graph_id=<?php print $_GET["local_graph_id"];?>&rra_id=<?php print $rra["id"];?>&view_type=<?php print $_REQUEST["view_type"];?>'><img src='images/graph_query.png' alt='CSV Export' title='CSV Export' style='border-width:0px;padding:3px;'></a><br>
							<a href='graph.php?action=properties&local_graph_id=<?php print $_GET["local_graph_id"];?>&rra_id=<?php print $rra["id"];?>&view_type=<?php print $_REQUEST["view_type"];?>'><img src='images/graph_properties.gif' alt='Graph Source/Properties' title='Graph Source/Properties' style='border-width:0px;padding:3px;'></a>
		...
		<td align='center'>
			<table width='1' cellpadding='0'>
				<tr>
					...
					<td valign='top' style='padding: 3px;' class='noprint'>
						<a href='graph.php?action=properties&local_graph_id=<?php print $_GET["local_graph_id"];?>&rra_id=<?php print $_GET["rra_id"];?>&view_type=<?php print $_REQUEST["view_type"];?>&graph_start=<?php print $graph_start;?>&graph_end=<?php print $graph_end;?>'><img src='images/graph_properties.gif' alt='Properties' title='Graph Source/Properties' style='border-width:0px;padding:3px;'></a>
						<a href='graph_xport.php?local_graph_id=<?php print $_GET["local_graph_id"];?>&rra_id=<?php print $_GET["rra_id"];?>&view_type=<?php print $_REQUEST["view_type"];?>&graph_start=<?php print $graph_start;?>&graph_end=<?php print $graph_end;?>'><img src='images/graph_query.png' alt='CSV Export' title='CSV Export' style='border-width:0px;padding:3px;'></a><br>
			...
			<table width='1' cellpadding='0'>
				<tr>
					...
					<td valign='top' style='padding: 3px;'>
						<a href='graph.php?action=zoom&local_graph_id=<?php print $_GET["local_graph_id"];?>&rra_id=<?php print $_GET["rra_id"];?>&view_type=<?php print $_REQUEST["view_type"];?>'><img src='images/graph_zoom.gif' alt='Zoom Graph' title='Zoom Graph' style='border-width:0px;padding:3px;'></a><br>
						<a href='graph_xport.php?local_graph_id=<?php print $_GET["local_graph_id"];?>&rra_id=<?php print $_GET["rra_id"];?>&view_type=<?php print $_REQUEST["view_type"];?>'><img src='images/graph_query.png' alt='CSV Export' title='CSV Export' style='border-width:0px;padding:3px;'></a><br>
