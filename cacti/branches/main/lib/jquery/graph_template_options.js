...
$(document).ready(function(){
	...
	var rrdtool_version = $('#rrdtool_version').val();
	if (rrdtool_version == '<?php print RRD_VERSION_1_0;?>') {
		$('.not_RRD_1_0_x').each(function() { $(this).parent().hide(); });
