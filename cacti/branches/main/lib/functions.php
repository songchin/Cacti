...
function pagehelp_url() {
	...
	$pagehelp_url = array(
		"about.php:" 								=> "",
		"cdef.php:" 								=> ":6_reference.rrdtool_specific_features#cdefs",
		"cdef.php:actions" 							=> ":6_reference.rrdtool_specific_features#cdefs",
		"cdef.php:edit" 							=> ":6_reference.rrdtool_specific_features#cdefs",
		"cdef.php:item_edit" 						=> ":6_reference.rrdtool_specific_features#cdefs",
		"cdef.php:remove" 							=> ":6_reference.rrdtool_specific_features#cdefs",
		"color.php:" 								=> "",
		"color.php:edit" 							=> "",
		"data_input.php:" 							=> ":3_advanced_topics.data_input_methods",
		"data_input.php:actions" 					=> ":3_advanced_topics.data_input_methods",
		"data_input.php:edit" 						=> ":3_advanced_topics.data_input_methods",
		"data_input.php:field_edit" 				=> ":3_advanced_topics.data_input_methods",
		"data_input.php:field_remove" 				=> ":3_advanced_topics.data_input_methods",
		"data_input.php:remove" 					=> ":3_advanced_topics.data_input_methods",
		"data_queries.php:" 						=> ":3_advanced_topics.data_queries",
		"data_queries.php:actions" 					=> ":3_advanced_topics.data_queries",
		"data_queries.php:edit" 					=> ":3_advanced_topics.data_queries",
		"data_queries.php:item_edit" 				=> ":3_advanced_topics.data_queries",
		"data_queries.php:item_remove" 				=> ":3_advanced_topics.data_queries",
		"data_sources.php:" 						=> "",
		"data_sources.php:actions" 					=> "",
		"data_sources.php:data_source_edit" 		=> "",
		"data_sources.php:ds_edit" 					=> "",
		"data_sources.php:ds_toggle_status" 		=> "",
		"data_templates.php:" 						=> ":3_advanced_topics.templates#data_templates",
		"data_templates.php:actions" 				=> ":3_advanced_topics.templates#data_templates",
		"data_templates.php:template_edit" 			=> ":3_advanced_topics.templates#data_templates",
		"gprint_presets.php:" 						=> ":6_reference.rrdtool_specific_features#gprint_presets",
		"gprint_presets.php:edit" 					=> ":6_reference.rrdtool_specific_features#gprint_presets",
		"gprint_presets.php:remove" 				=> ":6_reference.rrdtool_specific_features#gprint_presets",
		"graph.php:" 								=> "",
		...
		"graph_templates_inputs.php:input_edit" 	=> ":3_advanced_topics.templates#graph_templates",
		"graph_templates_inputs.php:input_remove" 	=> ":3_advanced_topics.templates#graph_templates",
		"graph_templates_items.php:item_edit" 		=> ":3_advanced_topics.templates#graph_templates",
		"graph_templates.php:" 						=> ":3_advanced_topics.templates#graph_templates",
		"graph_templates.php:actions" 				=> ":3_advanced_topics.templates#graph_templates",
		"graph_templates.php:actions" 				=> ":3_advanced_topics.templates#graph_templates",
		"graph_templates.php:template_edit" 		=> ":3_advanced_topics.templates#graph_templates",
		"graph_view.php:" 							=> "",
		"graph_view.php:list" 						=> "",
		...
		"host.php:actions" 							=> "",
		"host.php:edit" 							=> "",
		"host_templates.php:" 						=> ":3_advanced_topics.templates#host_templates",
		"host_templates.php:actions" 				=> ":3_advanced_topics.templates#host_templates",
		"host_templates.php:edit" 					=> ":3_advanced_topics.templates#host_templates",
		"index.php:" 								=> ":2_basics#basics",
		"index.php:login" 							=> ":2_basics#basics",
		"rra.php:" 									=> "",
		"rra.php:edit" 								=> "",
		"rra.php:remove" 							=> "",
		"settings.php:" 							=> "",
		...
		"tree.php:edit" 							=> "",
		"tree.php:item_edit" 						=> "",
		"tree.php:item_remove" 						=> "",
		"tree.php:remove" 							=> "",
		"user_admin.php:" 							=> "",
		"user_admin.php:actions" 					=> "",
		"user_admin.php:graph_perms_edit" 			=> "",
		"user_admin.php:graph_settings_edit" 		=> "",
		"user_admin.php:user_edit" 					=> "",
		"user_admin.php:user_realms_edit" 			=> "",
		"utilities.php:" 							=> "",
	...
	/* find the current page in the big array */
	return CACTI_WIKI_URL . $pagehelp_url{$current_page . ":" . $current_action};
}
