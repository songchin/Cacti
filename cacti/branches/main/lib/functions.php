...
function draw_navigation_text() {
	...
	$nav = array(
		...
		"data_templates.php:data_template_edit" => array("title" => __("(Edit)"), "mapping" => "index.php:,data_templates.php:", "url" => "", "level" => "2"),
		"data_templates_items.php:item_edit" => array("title" => __("Data Template Items"), "mapping" => "index.php:,data_templates.php:,data_templates.php:data_template_edit", "url" => "", "level" => "3"),
