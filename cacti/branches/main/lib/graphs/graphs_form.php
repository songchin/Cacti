...
#	print "<form method='post' action='graphs.php'>\n";
	...
	if (!empty($graphs["graph_template_id"])) {
		...
		draw_nontemplated_fields_graph_item($graphs["graph_template_id"], $_GET["id"], "|field|_|id|", "<strong>" . __("Graph Item Fields") ."</strong>", true);
